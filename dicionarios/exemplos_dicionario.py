...
def cadastrar_dados():
    ...
    for nota in range(4):
        aluno['nota'].append(float(input(f'Nota {nota+1}: ')))

    aluno['endereço'] = {}
    aluno['endereço']['cidade'] = input('digite a cidade do aluno' )
    aluno['endereço']['rua'] = input('digite a rua do aluno' )
    aluno['endereço']['numero'] = int(input('digite o numero da casa do aluno'))
    aluno['endereço']['telefonp'] = input('digite o telefone do aluno' )
